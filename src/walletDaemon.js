...
module.exports = class walletNode extends EventEmitter {
  constructor (nodeAddress, readyCallback) {
    ...
    const packageDefinition = protoLoader.loadSync(__dirname + '/../protos/astrixwalletd.proto', {
      keepCase: true,
      longs: String,
      enums: String,
      defaults: true,
      oneofs: true
		...
		const { astrixwalletd } = gRPC.loadPackageDefinition(packageDefinition).astrixwalletd

    this._client = new astrixwalletd(nodeAddress, gRPC.credentials.createInsecure(), {  
